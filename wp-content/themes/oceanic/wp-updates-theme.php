...
new WPUpdatesThemeUpdater_1091( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_1091') ) {
    class WPUpdatesThemeUpdater_1091 {
