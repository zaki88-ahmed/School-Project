...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'oceanic' ),
		'cyrillic'     => __( 'Cyrillic', 'oceanic' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'oceanic' ),
		'devanagari'   => __( 'Devanagari', 'oceanic' ),
		'greek'        => __( 'Greek', 'oceanic' ),
		'greek-ext'    => __( 'Greek Extended', 'oceanic' ),
		'khmer'        => __( 'Khmer', 'oceanic' ),
		'latin'        => __( 'Latin', 'oceanic' ),
		'latin-ext'    => __( 'Latin Extended', 'oceanic' ),
		'vietnamese'   => __( 'Vietnamese', 'oceanic' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'oceanic' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'oceanic' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'oceanic' ),
