 ...
 * Needed to extend the DTDSI_HM_WXR_Importer class to get/set the importer protected variables,
...
// Include files.
require DTDSI_PATH . 'inc/importer/class-wxr-importer.php';

class DTDSI_WXR_Importer extends DTDSI_HM_WXR_Importer {
