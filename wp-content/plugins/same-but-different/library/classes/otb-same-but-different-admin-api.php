...
class OTB_Same_But_Different_Admin_API {
	...
	public function display_field ( $data = array(), $post = false, $echo = true ) {
		...
		switch( $field['type'] ) {
			...
			case 'color':
				?>
				<input type="text" name="<?php esc_attr_e( $option_name ); ?>" class="colorpicker" maxlength="7" value="<?php esc_attr_e( $data ); ?>" />
			    <?php
			break;
		...
		switch( $field['type'] ) {
			case 'range':
				$html .= '<input id="' . esc_attr( $field['id'] ) . '" type="range" min="' . esc_attr( $field['input_attrs']['min'] ) . '" max="' . esc_attr( $field['input_attrs']['max'] ) . '" step="' . esc_attr( $field['input_attrs']['step'] ) . '" name="' . esc_attr( $option_name ) . '" value="' . esc_attr( $data ) . '" />' . "\n";
			break;
		}		
